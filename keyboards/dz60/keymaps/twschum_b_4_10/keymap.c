...
/* Keycode to go to numpad layer OR just as alt */
#ifdef TWSCHUM_NUMPAD_LAYER
#define NUM_ALT MO(_Num)
#else
#define NUM_ALT KC_RALT
#endif

/* Vimkey or not */
#ifdef TWSCHUM_VIM_LAYER
#define VIM_KEY VIM_START
#else
#define VIM_KEY KC_MEH
#endif

/* keycount key */
#ifdef TWSCHUM_KEYCOUNT
#define KEYCOUNT_ KEYCOUNT
#else
#define KEYCOUNT_ XXXXXXX
#endif

/* Shift-tap for forward slash can be annoying */
#define SHFT_SLASH KC_SLSH
...
// |------2.25--------|---Z----|---X----|---C----|---V----|---B----|---N----|---M----|---,----|---.----||----1.75------|--------|--------||
      KC_LSHIFT,        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,   KC_COMM,  KC_DOT,    SHFT_SLASH,   KC_UP,  VIM_KEY,
// |------------------|--------|--------|--------|--------|--------|--------|--------|--------|--------||--------------|--------|--------||
//
...
//
// |----1.5-----||---Q----|---W----|---E----|---R----|---T----|---Y----|---U----|---I----|---O----|---P----|---[----|---]----|----1.5-----|
      KC_TAB,   CODE_PASTE, KC_HOME, KC_UP,   KC_END, XXXXXXX, KC_HOME, KC_PGDN, KC_PGUP,  KC_END,VIM_PASTE, XXXXXXX, XXXXXXX,  CODE_PASTE,
// |------------||--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|------------|
//
// |----1.75------||---A----|---S----|---D----|---F----|---G----|---H----|---J----|---K----|---L----|---;----|---'----|------2.25--------||
      KC_CAPS,      _______, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, KC_LEFT, KC_DOWN,  KC_UP,  KC_RGHT, XXXXXXX, XXXXXXX,     KC_ENT,
// |--------------||--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|------------------||
//
// |------2.25--------|---Z----|---X----|---C----|---V----|---B----|---N----|---M----|---,----|---.----||----1.75------|--------|--------||
...
// |----------|----------||----------||----------------------||----------|------------------||--------|--------|--------|--------|--------|
  ...
  LAYOUT_b_4_10(
// |--------|----1---|----2---|----3---|---4----|---5----|---6----|---7----|---8----|---9----|---0----|-- - ---|-- = ---||------2.0-------|
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,TG_L0_RGB, XXXXXXX,XXXXXXX,      XXXXXXX,
// |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------||----------------|
//
// |----1.5-----||---Q----|---W----|---E----|---R----|---T----|---Y----|---U----|---I----|---O----|---P----|---[----|---]----|----1.5-----|
      XXXXXXX,    XXXXXXX,  KC_NO,  XXXXXXX,  RESET,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   RGB_HUD,
// |------------||--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|------------|
//
// |----1.75------||---A----|---S----|---D----|---F----|---G----|---H----|---J----|---K----  |---L----     |---;----       |---'----         |------2.25--------||
      XXXXXXX,      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KEYCOUNT_, TG_LAYER_RGB, RGB_MODE_PLAIN, RGB_MODE_FORWARD, KC_RSHIFT,
// |--------------||--------|--------|--------|--------|--------|--------|--------|--------  |--------     |--------       |--------         |------------------||
//
// |------2.25--------|---Z----|---X----|---C----|---V----|---B----|---N----|---M----|---,----|---.----||----1.75------|--------|--------||
